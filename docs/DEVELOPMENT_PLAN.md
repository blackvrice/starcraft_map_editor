...
| M6.3.1. 유닛·무기 EUD 확장 | 진행 | 5개 후보 필드 매니페스트·구조 검증 구현, 프로젝트·UI·실제 적용 대기 |
...
2026-09-14 사용자 우선순위에 따라 M6.3.1 EUD 확장 개발로 이동했다. M6.3의 무기·업그레이드·클로킹 게임 확인과 나머지 사례 검증은 대기 상태로 유지한다. 다음 개발은 EUD 선언적 프로젝트 저장 모델이며, 실제 지원 활성화 전 도구·게임 검증을 별도로 완료해야 한다.
