...
| M6.3. 맵·플레이어·게임 설정 | 진행 | 맵·플레이어·세력·유닛·생산 허용·업그레이드·테크 설정 구현, 검색·ID 범위 복사 구현, 통합 설정 탭·게임 검증 대기 |
...
다음 구현 작업은 M6.3의 Map Settings 통합 탭과 Players/Forces 공통 선택·플레이어 범위 및 Inspector 안내다.
...
- [ ] Map Settings 통합 탭, Players/Forces 공통 선택·플레이어 범위 및 Inspector 안내 구현
