...
2026-09-14 기록: 사용자가 이 기준/변경 맵의 테스트 완료를 보고했다. 개별 관찰값·게임 build·스크린샷은 제공되지 않았으며, 다른 설정 사례까지 통과한 것으로 확대하지 않는다.
...
완료로 표시하지 않으며, M6.3의 전체 게임 검증은 계속 미완료다. 다음 사례는 [무기·업그레이드·클로킹 비교](SETTINGS_COMBAT_SMOKE.md)다.
